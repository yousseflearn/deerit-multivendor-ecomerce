...
export default function SmallCard({ data }) {
  const { title, amount, color, icon, bgColor } = data;
  return (
    <div className="min-w-0 rounded-lg overflow-hidden bg-white dark:bg-gray-800 flex h-full">
      <div className="p-4 flex items-center border border-gray-200 dark:border-gray-800 w-full rounded-lg ">
        <div
          className={`flex justify-center items-center p-3  rounded-full h-12 w-12 text-center mr-4 text-lg ${color} dark:${bgColor}`}
        >
          {icon}
        </div>
        <div className="">
